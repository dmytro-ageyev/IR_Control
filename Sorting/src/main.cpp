...
void setup()
{
  ...
  WaitAnyKey(F("Натисніть будь-яку клавішу, щоб заповнити масив випадковими числами..."));
  FillArray(MyArr, MY_ARRAY_SIZE); 

  // Вивід початкового (несортованого) масиву
  WaitAnyKey(F("Натисніть будь-яку клавішу, щоб переглянути вміст масиву..."));
  PrintArray(MyArr, MY_ARRAY_SIZE, "Несортований масив:");

  // Сортування масиву
  WaitAnyKey(F("Натисніть будь-яку клавішу, щоб відсортувати масив методом 'Бульбашки'..."));
...
void FillArray(int arr[], int size)
{
  ...
  Serial.println(F("Масив заповнено випадковими числами.\r\n"));
}
...
void BubbleSort(int arr[], int size)
{
  ...
  Serial.println(F("Виконується сортування масиву методом 'Бульбашки'...\r\n"));
